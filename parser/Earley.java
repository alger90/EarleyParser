...
public class Earley 
{
	...
	public static void main(String[] args) throws Exception 
	{
		...
		///////////////////////////////////////////////////////////////////////////////////////
		Rule N = new Rule("N", new Production("airport"), new Production("airports"), new Production("runway"), new Production("runways"), new Production("dishes"), 
				new Production("restaurant"), new Production("boy"), new Production("house"));
		Rule D = new Rule("D", new Production("the"),new Production("The"), new Production("a"), new Production("an"),new Production("Some"));
		Rule V = new Rule("V", new Production("offered"), new Production("built"), new Production("sleep"), 
		...
		Rule Adj = new Rule("Adj", new Production("new"), new Production("beautiful"));
		Rule Adv = new Rule("Adv", new Production("very"), new Production("Very"));
		Rule ProN = new Rule("ProN", new Production("His"), new Production("Mary's"));
		
		Rule AdjP = new Rule("AdjP", new Production(Adj), new Production(Adv, Adj), new Production(Adj, Adv));
		Rule Quant = new Rule("Quant", new Production("four"), new Production("second"), new Production("Some"));
		
		Rule PP = new Rule("PP");
		Rule NP = new Rule("NP", new Production(N), new Production(N,N),
				new Production("houston"));
		NP.add(new Production(D, NP));
		NP.add(new Production(AdjP, NP));
		NP.add(new Production(Quant, NP));
		NP.add(new Production(NP, PP));
		NP.add(new Production(ProN,NP));
		...
		Rule RelPro = new Rule("RelPro", new Production("that"), new Production("which")); 
		Rule RelCl = new Rule("RelCl", new Production(RelPro,V,NP),new Production(RelPro, NP, V));
		
		NP.add(new Production(NP, RelCl));
		
		// let's parse some sentences!
		for (String text : new String[] {"four new airports", "Very new airport runways", "His second house", "Some beautiful dishes which a restaurant offered", "The runway that the airport built"}) {
			Parser p = new Parser(NP, text);
